...
const cloudinaryUpload = async (req, res, next) => {
	try {
		...
		// Utilisation de multer pour gérer le ficher depuis la requête
		UploadStream.single('image')(res, res, async (err) => {
			console.log('Multer à terminer de gérer le fichier');
			...
			try {
				console.log('Debut du téléversement sur cloudinary');
